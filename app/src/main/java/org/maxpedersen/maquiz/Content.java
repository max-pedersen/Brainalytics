...
//The constructor to initiate the class
    ...
    public static ArrayList<Content> getContent() {
        ...
        weeklyContent.add(new Content("2", "Good charts Ch. 1-4", "Five high level principles are key to visual communication. \n" +
                "1) We don't go in order: Visuals aren't read in a predictable, linear way as text is. Instead, we look first at the visual and then scan the chart for contextual clues about what is important. \n\n" +
                "2) We see first what stands out. Our eyes go directly to change and difference, such as unique colours, steep curves, clusters or outliers. \n\n" +
                "3) We see only a few things at once. The more data that's plotted on a chart, the more singular the idea it conveys. \n\n" +
                "4) We seek meaning and make connections. Our minds incessantly try to assign meaning to a visual and make casual connections between the elements presented. \n\n" +
                "5) We rely on conventions and metaphors. We use learned shortcuts to assign meaning to visual cues. \n\n" +
                "", "There are two key questions to ask when deciding what kind of visual communication to undertake. \n" +
                "1) Is my information conceptual or data-driven? \n\n" +
                "2) Are my visuals meant to be declarative or exploratory? \n\n",
                "Final 3", "Final 4",  "https://www.youtube.com"));
        weeklyContent.add(new Content("3", "Good charts Ch. 5-9", "To make charts feel neat or clean, focus on design structure and hierarchy. Include four elements in all charts:\n" +
                ...
                "                \"the chart's structure. Remove ambiguity. Use conventions and metaphors. " +
                "To make charts that look elegant or beautiful, focus on design simplicity. Show only what's needed. Every element should be necessary, unique, and rendered as simply as possible. \n" +
                ...
                "To make charts more persuasive, use three techniques. 1) Hone the main idea- Start with determining 'I need to convince them that...', then 'What am I trying to say or show? \n" +
        ...
        weeklyContent.add(new Content("7", "Knowledge sharing articles", "h", "h", "", "", ""));
